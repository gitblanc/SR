...
function initMap() { 
    ...
    $.getJSON('http://192.168.62.187/index?datos', function(data) {
        console.log("hola")
...
function apagarLed() {
    $.getJSON('http://192.168.62.187/index?apagar', function(data) {
    });
}

function encenderLed() {
    $.getJSON('http://192.168.62.187/index?encender', function(data) {
    });
}