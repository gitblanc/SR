...
const direccion_ip = "192.168.61.203";
...
const descrip2 = '<div id="content">' +
    ...
    "</div>" +
    "</div>";
const descrip3 = '<div id="content">' +
    '<div id="siteNotice">' +
    "</div>" +
    '<h1 id="firstHeading" class="firstHeading">Robot 3</h1>' +
    '<div id="bodyContent">' +
    "<p><b>No funciona</b>, XXX ºC <b>Calle Logroño</b></p>" +
    '<p>Attribution: Robot 1, <a href="https://es.wikipedia.org/wiki/Oviedo">' +
    "https://en.wikipedia.org/w/index.php?title=Oviedo</a></p>" +
    "</div>" +
    "</div>";
